...
export function Reviews({ reviews, query, setQuery, updateReview, archiveReview, setModal, onOpen, sync, onRetry, teamList = [] }) {
  ...
  const selectionMixed = selected.length > 0 && !allSelected;
